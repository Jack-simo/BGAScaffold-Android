package cn.bingoogolapple.bottomnavigation.util;
...
public class LocationHelper implements BDLocationListener {
    private static DecimalFormat sDecimalFormatM = new DecimalFormat("###,###,###");
    private static DecimalFormat sDecimalFormatKm = new DecimalFormat("###,###,###.0");
    ...
    public static String formatDistance(float distance) {
        if (distance < 1000) {
            return sDecimalFormatM.format(distance) + "m";
        } else {
            return sDecimalFormatKm.format(distance / 1000) + "km";
        }
    }
