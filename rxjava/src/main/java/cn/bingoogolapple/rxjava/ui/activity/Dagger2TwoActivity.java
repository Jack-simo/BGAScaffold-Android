 ...
 * 描述:
 */
public class Dagger2TwoActivity extends TitlebarActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        setContentView(R.layout.activity_dagger2_two);
        mResultTv = getViewById(R.id.tv_dagger2_two_result);
    }
    ...
    public void dagger2Three(View v) {
        forward(Dagger2ThreeActivity.class);
    }
